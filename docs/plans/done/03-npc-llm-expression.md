...
status: done · created: 2026-07-20 · closed: 2026-07-20 · ref: docs/design/20260720-engine-and-workflow-plan §1.3
...
- [x] 무료티어 가드: 프레임 호출 0·키 env·thinking off (캐시·디바운스는 04로 이관)
- [→] LLM 캐시·디바운스 → 04-endgame-and-polish
- [→] 대사 로그/검증(제출물 ④ AI 기술문서 소재) → 04-endgame-and-polish
