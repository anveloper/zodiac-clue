...
- [ ] CLAUDE.md에 plans 워크플로우 규칙 추가 (active→done, 압축 .md, 이중화)
- [ ] AGENTS.md 생성 (CODEX용, CLAUDE.md와 동일 규칙 참조)
- [ ] 이중화 규칙 명시: docs/plans=.md only, 그 외=.md+.html
- [ ] .html 생성 방식 결정: 수기 vs md→html 빌드 스크립트(pnpm docs:build)
