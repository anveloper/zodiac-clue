...
- 📚 **문서 대시보드(공개)**: https://zodiac-clue.site/docs/ — 설계·플랜·개발일지
- 🖥 **API 서버**: `wss://api.zodiac-clue.site` (OCI, Colyseus · 별칭 `wss://141-147-157-219.sslip.io`)
...
- [ ] 계략 다양화 · 고정NPC 다른 역할 · 엔진/콘텐츠 분리 · 음성(TTS)
