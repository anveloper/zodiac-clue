...
export const SCREEN = {
  ...
  viewports: [
    ...
    /* **2단 조판의 하한 그 자체**를 잰다. 계약이 가장 얇은 곳은 경계인데, 43회차 초안은
       ...
       ⚠️ 이 높이 375는 **기기 포인트 크기**이지 브라우저가 주는 높이가 아니다 —
          실기는 툴바만큼 더 낮고, 667×325에서는 아직 깨진다(검수 실측 · 큐). */
    { id: "edge", label: "2단 하한 620×375", width: 620, height: 375, dsf: 2, mobile: true, coarse: true },
  ],
