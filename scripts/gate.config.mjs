...
export const ITEMS = {
  ...
  screen: {
    id: "screen",
    label: "화면 게이트 (겹침·스크롤·터치·뷰간HUD·글자크기·대비·목록배지)",
    quick: false,
    // 근거(실측 ≈49s · `--full` ≈62s): Colyseus 서버 + Vite + Chrome 기동은 한 번뿐이고
    ...
    why: "브라우저·서버·클라를 실제로 띄운다(실측 ≈49s, `--full` ≈62s, 포트 2개 + Chrome). quick(≈3s)에 넣으면 16배 무거워지고 남의 dev와 자원을 다툰다 — push·촬영·제출 전 전체 모드 전용.",
  },
};
